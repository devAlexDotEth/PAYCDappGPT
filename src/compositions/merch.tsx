      ...
      <Stack direction='VERTICAL' localStyles={{marginTop: 86, marginBottom: 94, '@media (min-width: 1080px)': { marginBottom: 50,}}}>
          ...
          <Grid
            ...
            <Card heading="Beyond Superstition" description='Merch by PAYCBATMAN' pfp={BatmanPFP} direction="HORIZONTAL">
              <Button as="a" size='M' variant="SECONDARY" href='https://www.beyondsuperstition.com/contact' target="_blank">Contact Store</Button>
              <Button as="a" size='M' variant='PRIMARY' href='https://www.beyondsuperstition.com/store' target="_blank">View Store</Button>
            </Card>
          </Grid>
